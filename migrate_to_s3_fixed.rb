#!/usr/bin/env ruby
# Migração de arquivos do storage local para AWS S3
...
puts "Encontrados #{total} arquivos para verificar..."
puts
...
blobs.each_with_index do |blob, index|
  ...
  begin
    ...
    begin
      ...
      # Arquivo não existe no S3, precisa migrar
    end
    
    # Fazer upload para S3
    File.open(local_path, 'rb') do |file|
      service.upload(blob.key, file, checksum: blob.checksum)
    end
    ...
    # Pausa a cada 100 arquivos para não sobrecarregar
